...
const subCategory = ({ products, productFilters, fetchProduct }) => {
    ...
    const subCategory = router.query ? router.query.subCategory : undefined;
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                const filteredProducts = allProducts.filter(product => product.subcategory === subCategory);
...
export default connect(mapStateToProps, mapDidpatchToProps)(subCategory);

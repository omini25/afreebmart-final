                                    ...
                                    <div className="login_wrap widget-taber-content background-white">
                                        <div className="padding_eight_all bg-white">
                                            <div className="heading_s1">
                                                ...
                                                <p>Already have an account? <Link legacyBehavior href="/page-login"><a>Log in instead!</a></Link></p>
                                            </div>
                                            <form method="post">
                                                ...
                                                <div className="login_footer form-group mb-50">
                                                    ...
                                                    <Link legacyBehavior href="/page-privacy-policy"><a><i className="fi-rs-book-alt mr-5 text-muted"></i>Lean more</a></Link>
                                                </div>

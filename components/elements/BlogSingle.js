                ...
                <div className="single-header style-2">
                    <div className="row">
                        <div className="col-xl-10 col-lg-12 m-auto">
                            <h6 className="mb-10">
                                <Link legacyBehavior href="#"><a>Recipes</a></Link>
                            </h6>
                            <h2 className="mb-10">
                            ...
                            <div className="single-header-meta">
                                <div className="entry-meta meta-1 font-xs mt-15 mb-15">
                                    <Link legacyBehavior href="#"><a className="author-avatar">
                                        <img
                                    ...
                                    <span className="post-by">
                                        By <Link legacyBehavior href="#"><a>Sugar Rosie</a></Link>
                                    </span>
                ...
                <div className="single-content">
                    <div className="row">
                        <div className="col-xl-10 col-lg-12 m-auto">
                            ...
                            <blockquote>
                                <p>
                                    Integer eu faucibus <Link legacyBehavior href="#"><a>dolor</a></Link>
                                    <sup>
                                        <Link legacyBehavior href="#"><a>[5]</a></Link>
                                    </sup>
                            ...
                            <div className="entry-bottom mt-50 mb-30">
                                <div className="tags w-50 w-sm-100">
                                    <Link legacyBehavior href="/blog-category-big"><a

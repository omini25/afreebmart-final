        ...
        <>
            <div className="widget-area">
                ...
                <div className="sidebar-widget widget-category-2 mb-50">
                    ...
                    <ul>
                        <li>
                            <Link legacyBehavior href="/products"><a> <img src="/assets/imgs/theme/icons/category-1.svg" alt="" />Milks & Dairies</a></Link><span className="count">30</span>
                        </li>
                        <li>
                            <Link legacyBehavior href="/products"><a> <img src="/assets/imgs/theme/icons/category-2.svg" alt="" />Clothing</a></Link><span className="count">35</span>
                        </li>
                        <li>
                            <Link legacyBehavior href="/products"><a> <img src="/assets/imgs/theme/icons/category-3.svg" alt="" />Pet Foods </a></Link><span className="count">42</span>
                        </li>
                        <li>
                            <Link legacyBehavior href="/products"><a> <img src="/assets/imgs/theme/icons/category-4.svg" alt="" />Baking material</a></Link><span className="count">68</span>
                        </li>
                        <li>
                            <Link legacyBehavior href="/products"><a> <img src="/assets/imgs/theme/icons/category-5.svg" alt="" />Fresh Fruit</a></Link><span className="count">87</span>
                        </li>
                    </ul>
                </div>
                ...
                <div className="sidebar-widget widget-tags mb-50 pb-10">
                    ...
                    <ul className="tags-list">
                        <li className="hover-up">
                            <Link legacyBehavior href="/blog-category-grid"><a><i className="fi-rs-cross mr-10"></i>Cabbage</a></Link>
                        </li>
                        <li className="hover-up">
                            <Link legacyBehavior href="/blog-category-grid"><a><i className="fi-rs-cross mr-10"></i>Broccoli</a></Link>
                        </li>
                        <li className="hover-up">
                            <Link legacyBehavior href="/blog-category-grid"><a><i className="fi-rs-cross mr-10"></i>Smoothie</a></Link>
                        </li>
                        <li className="hover-up">
                            <Link legacyBehavior href="/blog-category-grid"><a><i className="fi-rs-cross mr-10"></i>Fruit</a></Link>
                        </li>
                        <li className="hover-up mr-0">
                            <Link legacyBehavior href="/blog-category-grid"><a><i className="fi-rs-cross mr-10"></i>Salad</a></Link>
                        </li>
                        <li className="hover-up mr-0">
                            <Link legacyBehavior href="/blog-category-grid"><a><i className="fi-rs-cross mr-10"></i>Appetizer</a></Link>
                        </li>
                    </ul>
                </div>

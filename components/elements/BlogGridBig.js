            ...
            {data.slice(0, show).map((item, i) => (
                ...
                <div className="position-relative overflow-hidden">
                    ...
                    <div className="post-thumb border-radius-15">
                        <Link legacyBehavior href="/blog-post-right"><a>
                ...
                <div className="entry-content">
                    <h2 className="post-title mb-20">
                        <Link legacyBehavior href="/blog-post-right"><a>{item.title} </a></Link>
                    </h2>
                    ...
                    <div className="mb-20 entry-meta meta-2">
                        ...
                        <Link legacyBehavior href="/blog-post-right"><a className="btn btn-sm">Read more<i className="fi-rs-arrow-right ml-10"></i></a></Link>
                    </div>
                </div>
            </article>
            ))}
